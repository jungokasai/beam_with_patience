...
def translate(model_dir,
    ...
    model = BARTModel.from_pretrained('/home/acd13578qu/data/cnndm/bart.large.cnn/', checkpoint_file='model.pt', data_name_or_path='/home/acd13578qu/data/cnndm/bart.large.cnn/')
    CNN_KWARGS = dict(beam=beam, lenpen=lenpen, max_len_b=140, min_len=55, no_repeat_ngram_size=3, patience_factor=patience_factor, vanilla=True)
    #CNN_KWARGS = dict(beam=beam, lenpen=lenpen, patience_factor=patience_factor)
    ...
    for i in range(nb_batches):
        ...
        output = model.sample(src_sents[i*batch_size:(i+1)*batch_size], **CNN_KWARGS)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-dir', type=str, metavar='N', 
                        default='/home/acd13578qu/data/cnndm/bart.large.cnn/', help='model directory')
    ...
    parser.add_argument('--in-file', type=str, metavar='N',
                        default='summ/cnndm/src/cnndm_src.txt', help='source file')
    ...
    parser.add_argument('--shard-id', default=0, type=int, metavar='N',
                        help='shard id')
    parser.add_argument('--lenpen', default=2.0, type=float, metavar='N',
                        help='length penalty')
    parser.add_argument('--beam', default=4, type=int, metavar='N',
                        help='beam size')
