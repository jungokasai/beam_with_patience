...
def translate(model_dir,
    ...
    for i in range(nb_batches):
        ...
        output = [sent.replace('[{}] '.format(lang), '') for sent in output]
        outputs.extend(output)
    end.record()
    # Waits for everything to finish running
    torch.cuda.synchronize()
    print('Time Elapsed')
    print(start.elapsed_time(end)/1000.0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-dir', type=str, metavar='N', 
                        default='/home/acd13578qu/data/MBART50/mbart50.ft.1n/', help='model directory')
    ...
    parser.add_argument('--in-file', type=str, metavar='N',
                        default='mt/en-ja/src/newstest2021.en-ja.src.en', help='source file')
    parser.add_argument('--out-file', type=str, metavar='N',
                        default='mt/en-ja/output/newstest2021.en-ja.mbart.p1.ja', help='target output file')
