...
def translate(model_dir,
    ...
    model = BARTModel.from_pretrained(model_dir, checkpoint_file=model_name, data_name_or_path=model_dir)
    CNN_KWARGS = dict(beam=beam, lenpen=lenpen, max_len_b=140, min_len=55, no_repeat_ngram_size=3, patience_factor=patience_factor, vanilla=vanilla)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, metavar='N',
                        default='summ/cnndm/output/cnndm_p1_default.txt', help='target output file')
