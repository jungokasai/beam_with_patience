...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        from fairseq.sequence_generator_vanilla import (
            SequenceGeneratorVanilla,
        )
        ...
        if seq_gen_cls is None:
            ...
            if getattr(args, "vanilla", False):
                seq_gen_cls = SequenceGeneratorVanilla
            else:
        ...
        return seq_gen_cls(
            ...
            patience_factor=getattr(args, "patience_factor", 1),
